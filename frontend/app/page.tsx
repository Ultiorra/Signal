    ...
    <main className="sig">
      <header className="sig-head">
        ...
        <p>
          ...
          the next two weeks and, more importantly, draws the confidence band
          around that projection. Markets aren&apos;t truly predictable — the
      ...
      {data && (
        <>
          ...
          <p className="sig-note">
            Features: lagged prices (1–30d), rolling means and volatility, and
            day-of-week. Model: gradient-boosted trees. The band widens with the
            horizon because uncertainty compounds the further out you predict.
          </p>

          <button className="sig-refresh" onClick={load}>Re-run with latest data</button>
        </>
      )}
    </main>
  );
